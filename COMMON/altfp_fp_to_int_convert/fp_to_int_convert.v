...
module  fp_to_int_convert_altbarrel_shift_20g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_to_int_convert_altbarrel_shift_20g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_to_int_convert_altfp_convert_nfn
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	fp_to_int_convert_altbarrel_shift_20g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp_to_int_convert_altfp_convert_nfn
//VALID FILE
...
module fp_to_int_convert (
	...
	fp_to_int_convert_altfp_convert_nfn	fp_to_int_convert_altfp_convert_nfn_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_int_convert.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_int_convert.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_int_convert.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_int_convert_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_int_convert_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_int_convert.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_int_convert.cmp FALSE TRUE
