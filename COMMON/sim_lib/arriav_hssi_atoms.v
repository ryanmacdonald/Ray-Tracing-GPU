...
assign refclkout  = ( enabled == "true") && ( divide_by == 1 ) ? refclkin : 
                    ( enabled == "true") && ( divide_by == 2 ) ? rxp_div2_180 :
...
#(
	...
	parameter regulator_volt_inc = "5",	//Valid values: 0|5|10|15|20|25|30|not_used
