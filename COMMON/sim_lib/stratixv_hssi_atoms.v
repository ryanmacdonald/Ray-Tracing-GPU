...
// --------------------------------------------------------------------
// This is auto-generated HSSI Simulation Atom Model Encryption Wrapper
// Module Name : stratixv_hssi_pma_int_wrapper_multirev.v
// --------------------------------------------------------------------
...
(
	...
	initial
	begin
		$display("module stratixv_hssi_pma_int : simulation model silicon_rev = \"%s\"", silicon_rev_local);
	end
	...
	generate
		if ((silicon_rev_local == "es") || (silicon_rev_local == "ES"))
		begin
			stratixv_hssi_pma_int_encrypted_ES #(
			...
			) stratixv_hssi_pma_int_encrypted_ES_inst (
				.dprioclk(dprioclk),
				.bslipo(bslipo),
				.slpbko(slpbko),
				.ltdo(ltdo),
		...
		begin
			stratixv_hssi_pma_int_encrypted #(
				...
				.txqpipullup(txqpipullup),
				.clk33pcs(clk33pcs),
				.pma_reserved_in_o(pma_reserved_in_o),
				.adaptdone(adaptdone),
				.avmmreaddata(avmmreaddata),
				.txqpipullupo(txqpipullupo),
				.rxqpipulldno(rxqpipulldno),
