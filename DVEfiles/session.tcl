...
# DVE full session
# Saved on Sat Oct 20 21:49:49 2012
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{184 49} {1402 1141}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 315} {height 676} {dock_state left} {dock_on_new_line true} {child_hier_colhier 247} {child_hier_coltype 80} {child_hier_col1 0} {child_hier_col2 1}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 284]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1220
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 284
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1218} {height 283} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMEXE {/afs/ece.cmu.edu/usr/rgd/545/18-545/simv}
...
catch { gui_list_select -id ${Data.1} {tb_int_math.valid_in tb_int_math.ray_out tb_int_math.EM_miss tb_int_math.valid_out tb_int_math.v0 tb_int_math.v1 tb_int_math.v2 tb_int_math.int_pipe1_in tb_int_math.hit_out tb_int_math.intersection_out tb_int_math.clk tb_int_math.bary_u_f tb_int_math.bary_v_f tb_int_math.t_int_f tb_int_math.rst tb_int_math.EM_ray_out }}
