...
# DVE full session
# Saved on Sun Oct 21 22:24:48 2012
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{652 48} {1616 1124}}
...
gui_sg_addsignal -group ${Group1} { tb_prg.fuck.rayReady tb_prg.fuck.px tb_prg.fuck.py tb_prg.fuck.pz tb_prg.fuck.cnt tb_prg.fuck.rayID tb_prg.fuck.v0 tb_prg.fuck.v1 tb_prg.fuck.v2 tb_prg.fuck.start_prg tb_prg.fuck.start }
gui_set_radix -radix {decimal} -signals {Sim:tb_prg.fuck.cnt}
gui_set_radix -radix {unsigned} -signals {Sim:tb_prg.fuck.cnt}
...
gui_wv_zoom_timerange -id ${Wave.1} 416 524
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {tb_prg.fuck.rayID }
...
gui_marker_move -id ${Wave.1} {C1} 485
