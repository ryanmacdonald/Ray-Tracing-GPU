...
# DVE full session
# Saved on Sat Oct 20 21:44:48 2012
# Designs open: 1
#   Sim: /afs/ece.cmu.edu/usr/rgd/545/18-545/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: tb_int_math
#   Group count = 0
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{6 47} {1121 1156}}
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 698
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 161} {height 698} {dock_state left} {dock_on_new_line true} {child_hier_colhier 152} {child_hier_coltype 10} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1115} {height 278} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 388} {child_data_colvalue 265} {child_data_coltype 296} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_open_source -id ${Source.1}  -replace -active tb_int_math /afs/ece.cmu.edu/usr/rgd/545/18-545/RAYTRACER/int/TBs/tb_int_math.sv
gui_view_scroll -id ${Source.1} -vertical -set 266
